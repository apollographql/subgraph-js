...
export interface ApolloGraphQLObjectTypeExtensions<
  _TSource = any,
  _TContext = any,
...
export interface ApolloGraphQLInterfaceTypeExtensions<
  _TSource = any,
  _TContext = any,
...
export interface ApolloGraphQLUnionTypeExtensions<
  _TSource = any,
  _TContext = any,
> extends GraphQLUnionTypeExtensions {
  apollo?: {
    subgraph?: ApolloSubgraphExtensions<_TContext>;
  };
}
